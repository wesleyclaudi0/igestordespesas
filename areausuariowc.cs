...
namespace GeneXus.Programs {
   public class areausuariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public areausuariowc( )
      {
      ...
      public areausuariowc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8AreaId = (long)(Math.Round(NumberUtil.Val( GetPar( "AreaId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8AreaId", StringUtil.LTrimStr( (decimal)(AV8AreaId), 18, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV8AreaId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV8AreaId, AV22Pgmname, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Area Usuario WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("areausuariowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8AreaId,18,0))}, new string[] {"AreaId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8AreaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8AreaId), 18, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vAREAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8AreaId), 18, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void RenderHtmlCloseFormEL2( )
      {
      ...
      {
         return "AreaUsuarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Area Usuario WC", "") ;
      }
      ...
      protected void WBEL0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "areausuariowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablegridheader_Internalname, 1, 0, "px", 0, "px", "Table100x100", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
      ...
      protected void STARTEL2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Area Usuario WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void RFEL2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00EL2 */
            pr_default.execute(0, new Object[] {AV8AreaId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_15_idx = 1;
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_15_idx), 4, 0), 4, "0");
            SubsflControlProps_152( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A1EmpresaId = H00EL2_A1EmpresaId[0];
               A102EmpresaAdministradorId = H00EL2_A102EmpresaAdministradorId[0];
               n102EmpresaAdministradorId = H00EL2_n102EmpresaAdministradorId[0];
               A689AreaId = H00EL2_A689AreaId[0];
               AssignAttri(sPrefix, false, "A689AreaId", StringUtil.LTrimStr( (decimal)(A689AreaId), 18, 0));
               A11UsuarioPerfil = H00EL2_A11UsuarioPerfil[0];
               n11UsuarioPerfil = H00EL2_n11UsuarioPerfil[0];
               A174UsuarioFuncaoNome = H00EL2_A174UsuarioFuncaoNome[0];
               A173UsuarioFuncaoId = H00EL2_A173UsuarioFuncaoId[0];
               n173UsuarioFuncaoId = H00EL2_n173UsuarioFuncaoId[0];
               A10UsuarioNome = H00EL2_A10UsuarioNome[0];
               A9UsuarioId = H00EL2_A9UsuarioId[0];
               A693AreaUsuarioId = H00EL2_A693AreaUsuarioId[0];
               A1EmpresaId = H00EL2_A1EmpresaId[0];
               A102EmpresaAdministradorId = H00EL2_A102EmpresaAdministradorId[0];
               n102EmpresaAdministradorId = H00EL2_n102EmpresaAdministradorId[0];
               A11UsuarioPerfil = H00EL2_A11UsuarioPerfil[0];
      ...
      protected void send_integrity_lvl_hashesEL2( )
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H00EL3 */
         pr_default.execute(1, new Object[] {AV8AreaId});
         GRID_nRecordCount = H00EL3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtAreaUsuarioId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAreaUsuarioId_Enabled), 5, 0), !bGXsfl_15_Refreshing);
         edtUsuarioId_Enabled = 0;
         AssignProp(sPrefix, false, edtUsuarioId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtUsuarioId_Enabled), 5, 0), !bGXsfl_15_Refreshing);
         edtUsuarioNome_Enabled = 0;
         AssignProp(sPrefix, false, edtUsuarioNome_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtUsuarioNome_Enabled), 5, 0), !bGXsfl_15_Refreshing);
         edtUsuarioFuncaoId_Enabled = 0;
         AssignProp(sPrefix, false, edtUsuarioFuncaoId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtUsuarioFuncaoId_Enabled), 5, 0), !bGXsfl_15_Refreshing);
         edtUsuarioFuncaoNome_Enabled = 0;
         AssignProp(sPrefix, false, edtUsuarioFuncaoNome_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtUsuarioFuncaoNome_Enabled), 5, 0), !bGXsfl_15_Refreshing);
         cmbUsuarioPerfil.Enabled = 0;
         AssignProp(sPrefix, false, cmbUsuarioPerfil_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbUsuarioPerfil.Enabled), 5, 0), !bGXsfl_15_Refreshing);
         edtAreaId_Enabled = 0;
      ...
      protected void STRUPEL0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8AreaId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8AreaId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV16Session.Get(AV22Pgmname+"GridState"), "") == 0 )
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV22Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV22Pgmname+"GridState"), null, "", "");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV22Pgmname+"GridState",  AV12GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV22Pgmname;
         AV10TrnContext.gxTpr_Callerondelete = true;
         AV10TrnContext.gxTpr_Callerurl = AV9HTTPRequest.ScriptName+"?"+AV9HTTPRequest.QueryString;
         AV10TrnContext.gxTpr_Transactionname = "Area";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "AreaId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8AreaId), 18, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8AreaId = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8AreaId", StringUtil.LTrimStr( (decimal)(AV8AreaId), 18, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8AreaId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "areausuariowc", GetJustCreated( ));
         ...
         {
            AV8AreaId = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8AreaId", StringUtil.LTrimStr( (decimal)(AV8AreaId), 18, 0));
         }
         wcpOAV8AreaId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8AreaId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8AreaId != wcpOAV8AreaId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8AreaId = AV8AreaId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8AreaId = cgiGet( sPrefix+"AV8AreaId_CTRL");
         if ( StringUtil.Len( sCtrlAV8AreaId) > 0 )
         {
            AV8AreaId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8AreaId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8AreaId", StringUtil.LTrimStr( (decimal)(AV8AreaId), 18, 0));
         }
         else
         {
            AV8AreaId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8AreaId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8AreaId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8AreaId), 18, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8AreaId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8AreaId_CTRL", StringUtil.RTrim( sCtrlAV8AreaId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202461819372639", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("areausuariowc.js", "?202461819372639", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtAreaUsuarioId_Internalname = sPrefix+"AREAUSUARIOID_"+sGXsfl_15_idx;
         edtUsuarioId_Internalname = sPrefix+"USUARIOID_"+sGXsfl_15_idx;
         edtUsuarioNome_Internalname = sPrefix+"USUARIONOME_"+sGXsfl_15_idx;
         edtUsuarioFuncaoId_Internalname = sPrefix+"USUARIOFUNCAOID_"+sGXsfl_15_idx;
         edtUsuarioFuncaoNome_Internalname = sPrefix+"USUARIOFUNCAONOME_"+sGXsfl_15_idx;
         cmbUsuarioPerfil_Internalname = sPrefix+"USUARIOPERFIL_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtAreaUsuarioId_Internalname = sPrefix+"AREAUSUARIOID_"+sGXsfl_15_fel_idx;
         edtUsuarioId_Internalname = sPrefix+"USUARIOID_"+sGXsfl_15_fel_idx;
         edtUsuarioNome_Internalname = sPrefix+"USUARIONOME_"+sGXsfl_15_fel_idx;
         edtUsuarioFuncaoId_Internalname = sPrefix+"USUARIOFUNCAOID_"+sGXsfl_15_fel_idx;
         edtUsuarioFuncaoNome_Internalname = sPrefix+"USUARIOFUNCAONOME_"+sGXsfl_15_fel_idx;
         cmbUsuarioPerfil_Internalname = sPrefix+"USUARIOPERFIL_"+sGXsfl_15_fel_idx;
      }
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAreaUsuarioId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A693AreaUsuarioId), 18, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A693AreaUsuarioId), "ZZZZZZZZZZZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAreaUsuarioId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)18,(short)0,(short)0,(short)15,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtUsuarioId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A9UsuarioId), 18, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A9UsuarioId), "ZZZZZZZZZZZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtUsuarioId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)18,(short)0,(short)0,(short)15,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtUsuarioNome_Internalname,StringUtil.RTrim( A10UsuarioNome),(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtUsuarioNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)60,(short)0,(short)0,(short)15,(short)1,(short)-1,(short)-1,(bool)true,(string)"Nome",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtUsuarioFuncaoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A173UsuarioFuncaoId), 18, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A173UsuarioFuncaoId), "ZZZZZZZZZZZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtUsuarioFuncaoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)18,(short)0,(short)0,(short)15,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            GXCCtl = "USUARIOPERFIL_" + sGXsfl_15_idx;
            ...
            AssignProp(sPrefix, false, cmbUsuarioPerfil_Internalname, "Values", (string)(cmbUsuarioPerfil.ToJavascriptSource()), !bGXsfl_15_Refreshing);
            send_integrity_lvl_hashesEL2( ) ;
      ...
      {
         edtAreaUsuarioId_Internalname = sPrefix+"AREAUSUARIOID";
         edtUsuarioId_Internalname = sPrefix+"USUARIOID";
         edtUsuarioNome_Internalname = sPrefix+"USUARIONOME";
         edtUsuarioFuncaoId_Internalname = sPrefix+"USUARIOFUNCAOID";
         edtUsuarioFuncaoNome_Internalname = sPrefix+"USUARIOFUNCAONOME";
         cmbUsuarioPerfil_Internalname = sPrefix+"USUARIOPERFIL";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:UsuarioNome|4:UsuarioFuncaoNome|5:UsuarioPerfil";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8AreaId',fld:'vAREAID',pic:'ZZZZZZZZZZZZZZZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E11EL2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8AreaId',fld:'vAREAID',pic:'ZZZZZZZZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E12EL2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8AreaId',fld:'vAREAID',pic:'ZZZZZZZZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E13EL2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8AreaId',fld:'vAREAID',pic:'ZZZZZZZZZZZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E16EL2',iparms:[]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Usuarioperfil',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         H00EL2_A1EmpresaId = new long[1] ;
         H00EL2_A102EmpresaAdministradorId = new long[1] ;
         H00EL2_n102EmpresaAdministradorId = new bool[] {false} ;
         H00EL2_A689AreaId = new long[1] ;
         H00EL2_A11UsuarioPerfil = new short[1] ;
         H00EL2_n11UsuarioPerfil = new bool[] {false} ;
         H00EL2_A174UsuarioFuncaoNome = new string[] {""} ;
         H00EL2_A173UsuarioFuncaoId = new long[1] ;
         H00EL2_n173UsuarioFuncaoId = new bool[] {false} ;
         H00EL2_A10UsuarioNome = new string[] {""} ;
         H00EL2_A9UsuarioId = new long[1] ;
         H00EL2_A693AreaUsuarioId = new long[1] ;
         H00EL3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.areausuariowc__default(),
            new Object[][] {
                new Object[] {
               H00EL2_A1EmpresaId, H00EL2_A102EmpresaAdministradorId, H00EL2_n102EmpresaAdministradorId, H00EL2_A689AreaId, H00EL2_A11UsuarioPerfil, H00EL2_n11UsuarioPerfil, H00EL2_A174UsuarioFuncaoNome, H00EL2_A173UsuarioFuncaoId, H00EL2_n173UsuarioFuncaoId, H00EL2_A10UsuarioNome,
               H00EL2_A9UsuarioId, H00EL2_A693AreaUsuarioId
               }
               , new Object[] {
               H00EL3_AGRID_nRecordCount
               }
            }
         );
         AV22Pgmname = "AreaUsuarioWC";
      ...
      private long AV8AreaId ;
      private long wcpOAV8AreaId ;
      ...
      private long[] H00EL2_A1EmpresaId ;
      private long[] H00EL2_A102EmpresaAdministradorId ;
      private bool[] H00EL2_n102EmpresaAdministradorId ;
      private long[] H00EL2_A689AreaId ;
      private short[] H00EL2_A11UsuarioPerfil ;
      private bool[] H00EL2_n11UsuarioPerfil ;
      private string[] H00EL2_A174UsuarioFuncaoNome ;
      private long[] H00EL2_A173UsuarioFuncaoId ;
      private bool[] H00EL2_n173UsuarioFuncaoId ;
      private string[] H00EL2_A10UsuarioNome ;
      private long[] H00EL2_A9UsuarioId ;
      private long[] H00EL2_A693AreaUsuarioId ;
      private long[] H00EL3_AGRID_nRecordCount ;
   ...
   public class areausuariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00EL2( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             long AV8AreaId ,
                                             long A689AreaId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[EmpresaId], T3.[EmpresaAdministradorId] AS EmpresaAdministradorId, T1.[AreaId], T4.[UsuarioPerfil], T5.[FuncaoNome] AS UsuarioFuncaoNome, T4.[UsuarioFuncaoId] AS UsuarioFuncaoId, T6.[UsuarioNome], T1.[UsuarioId], T1.[AreaUsuarioId]";
         sFromString = " FROM ((((([AreaUsuario] T1 INNER JOIN [Area] T2 ON T2.[AreaId] = T1.[AreaId]) INNER JOIN [Empresa] T3 ON T3.[EmpresaId] = T2.[EmpresaId]) LEFT JOIN [Usuario] T4 ON T4.[UsuarioId] = T3.[EmpresaAdministradorId]) LEFT JOIN [Funcao] T5 ON T5.[FuncaoId] = T4.[UsuarioFuncaoId]) INNER JOIN [Usuario] T6 ON T6.[UsuarioId] = T1.[UsuarioId])";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[AreaId] = @AV8AreaId)");
         if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[AreaId], T6.[UsuarioNome]";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[AreaId] DESC, T6.[UsuarioNome] DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[AreaId], T5.[FuncaoNome]";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[AreaId] DESC, T5.[FuncaoNome] DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[AreaId], T4.[UsuarioPerfil]";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[AreaId] DESC, T4.[UsuarioPerfil] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.[AreaId], T1.[AreaUsuarioId]";
         }
      ...
      protected Object[] conditional_H00EL3( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             long AV8AreaId ,
                                             long A689AreaId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((((([AreaUsuario] T1 INNER JOIN [Area] T2 ON T2.[AreaId] = T1.[AreaId]) INNER JOIN [Empresa] T3 ON T3.[EmpresaId] = T2.[EmpresaId]) LEFT JOIN [Usuario] T4 ON T4.[UsuarioId] = T3.[EmpresaAdministradorId]) LEFT JOIN [Funcao] T6 ON T6.[FuncaoId] = T4.[UsuarioFuncaoId]) INNER JOIN [Usuario] T5 ON T5.[UsuarioId] = T1.[UsuarioId])";
         AddWhere(sWhereString, "(T1.[AreaId] = @AV8AreaId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00EL2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
               case 1 :
                     return conditional_H00EL3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH00EL2;
          prmH00EL2 = new Object[] {
          new ParDef("@AV8AreaId",GXType.Decimal,18,0) ,
          new ParDef("@GXPagingFrom2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0)
          };
          Object[] prmH00EL3;
          prmH00EL3 = new Object[] {
          new ParDef("@AV8AreaId",GXType.Decimal,18,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00EL2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00EL2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00EL3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00EL3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
