...
namespace GeneXus.Programs {
   public class acessomenumodulo : GXProcedure
   {
      public acessomenumodulo( )
      {
      ...
      public acessomenumodulo( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         pr_default.close(0);
         /* Using cursor P00I13 */
         pr_default.execute(1, new Object[] {AV12UsuarioPerfilId, AV9ModuloNome});
      ...
      public override void initialize( )
      {
         ...
         A748ModuloNome = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.acessomenumodulo__default(),
            new Object[][] {
                new Object[] {
   ...
   public class acessomenumodulo__default : DataStoreHelperBase, IDataStoreHelper
   {
