...
namespace GeneXus.Programs {
   public class aprcimpressaoosmodelo5 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public aprcimpressaoosmodelo5( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         gxXPage = 100;
         gxYPage = 100;
         setOutputFileName("ImpressaoM5.pdf");
         setOutputType("pdf");
         try
         {
            Gx_out = "FIL" ;
            ...
            {
               A36ServicoSetorId = P008B2_A36ServicoSetorId[0];
               A38GestaoServicoId = P008B2_A38GestaoServicoId[0];
               A77ServicoEmpresaId = P008B2_A77ServicoEmpresaId[0];
               A79GestaoServicoNumero = P008B2_A79GestaoServicoNumero[0];
               A40GestaoServicoDescricao = P008B2_A40GestaoServicoDescricao[0];
               A35ServicoClienteNome = P008B2_A35ServicoClienteNome[0];
               A37ServicoSetorNome = P008B2_A37ServicoSetorNome[0];
               A54ServicoNaturezaNome = P008B2_A54ServicoNaturezaNome[0];
               A41GestaoServicoPrioridade = P008B2_A41GestaoServicoPrioridade[0];
               A42GestaoServicoStatus = P008B2_A42GestaoServicoStatus[0];
               A43GestaoServicoDtProgramada = P008B2_A43GestaoServicoDtProgramada[0];
               A39GestaoServicoDtHora = P008B2_A39GestaoServicoDtHora[0];
               A157GestaoServicoPrecificacao = P008B2_A157GestaoServicoPrecificacao[0];
               A53ServicoNaturezaId = P008B2_A53ServicoNaturezaId[0];
               n53ServicoNaturezaId = P008B2_n53ServicoNaturezaId[0];
               A129EnderecoId = P008B2_A129EnderecoId[0];
               n129EnderecoId = P008B2_n129EnderecoId[0];
               A34ServicoClienteId = P008B2_A34ServicoClienteId[0];
               A322GestaoServicoTipoDemanda = P008B2_A322GestaoServicoTipoDemanda[0];
               A420GestaoServicoTipoHH = P008B2_A420GestaoServicoTipoHH[0];
               n420GestaoServicoTipoHH = P008B2_n420GestaoServicoTipoHH[0];
               A37ServicoSetorNome = P008B2_A37ServicoSetorNome[0];
               A54ServicoNaturezaNome = P008B2_A54ServicoNaturezaNome[0];
               A35ServicoClienteNome = P008B2_A35ServicoClienteNome[0];
            ...
            {
               A106ClienteEnderecoId = P008B3_A106ClienteEnderecoId[0];
               A17ClienteId = P008B3_A17ClienteId[0];
               A107ClienteEnderecoLocal = P008B3_A107ClienteEnderecoLocal[0];
            ...
            {
               A1EmpresaId = P008B4_A1EmpresaId[0];
               A2EmpresaNome = P008B4_A2EmpresaNome[0];
               A3EmpresaCNPJ = P008B4_A3EmpresaCNPJ[0];
               A40000EmpresaFoto_GXI = P008B4_A40000EmpresaFoto_GXI[0];
            ...
            {
               A38GestaoServicoId = P008B5_A38GestaoServicoId[0];
               A326TipoServicoNome = P008B5_A326TipoServicoNome[0];
               A329TipoServicoEstimado = P008B5_A329TipoServicoEstimado[0];
               A325TipoServicoId = P008B5_A325TipoServicoId[0];
               A323GestaoServicoTipoId = P008B5_A323GestaoServicoTipoId[0];
               A326TipoServicoNome = P008B5_A326TipoServicoNome[0];
               A329TipoServicoEstimado = P008B5_A329TipoServicoEstimado[0];
            ...
            if ( AV40PerfilUsuario != 4 )
            {
               if ( AV32GestaoServicoPrecificacao == 2 )
               {
                  ...
                  while ( AV99GXV1 <= AV82ServicoNaturezaIdCollection.Count )
                  {
                     ...
                     {
                        A25NaturezaId = P008B6_A25NaturezaId[0];
                        A162NaturezaValor = P008B6_A162NaturezaValor[0];
                        A289NaturezaCusto = P008B6_A289NaturezaCusto[0];
               ...
               else
               {
                  ...
                  if ( AV32GestaoServicoPrecificacao == 1 )
                  {
                     ...
                     {
                        A38GestaoServicoId = P008B7_A38GestaoServicoId[0];
                        A55ServicoExecutanteId = P008B7_A55ServicoExecutanteId[0];
                        n55ServicoExecutanteId = P008B7_n55ServicoExecutanteId[0];
                        A131GestaoServicoExecutanteId = P008B7_A131GestaoServicoExecutanteId[0];
                        AV102GXV2 = 1;
                     ...
                     while ( AV103GXV3 <= AV44ServicoExecutanteIdCollection.Count )
                     {
                        ...
                        {
                           A9UsuarioId = P008B8_A9UsuarioId[0];
                           A173UsuarioFuncaoId = P008B8_A173UsuarioFuncaoId[0];
                           n173UsuarioFuncaoId = P008B8_n173UsuarioFuncaoId[0];
                           A10UsuarioNome = P008B8_A10UsuarioNome[0];
                        ...
                        pr_default.close(6);
                        H8B0( false, 51) ;
                        getPrinter().GxDrawRect(67, Gx_line+33, 684, Gx_line+50, 1, 0, 0, 0, 1, 60, 179, 113, 0, 0, 0, 0, 0, 0, 0, 0) ;
                        getPrinter().GxAttris("Microsoft Sans Serif", 9, true, false, false, false, 0, 255, 255, 255, 0, 255, 255, 255) ;
                        getPrinter().GxDrawText(context.GetMessage( "Tipo de Hora", ""), 83, Gx_line+33, 175, Gx_line+51, 0, 0, 0, 0) ;
                        getPrinter().GxDrawText(context.GetMessage( "Valor por Hora", ""), 350, Gx_line+33, 458, Gx_line+51, 0, 0, 0, 0) ;
                        getPrinter().GxDrawRect(192, Gx_line+33, 284, Gx_line+50, 1, 0, 0, 0, 0, 255, 255, 255, 0, 1, 1, 0, 0, 0, 0, 0) ;
                        getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                        getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV75TecnicoNome, "")), 242, Gx_line+0, 509, Gx_line+15, 1, 0, 0, 0) ;
                        getPrinter().GxDrawRect(333, Gx_line+33, 425, Gx_line+50, 1, 0, 0, 0, 0, 255, 255, 255, 0, 1, 1, 0, 0, 0, 0, 0) ;
                        getPrinter().GxAttris("Microsoft Sans Serif", 9, true, false, false, false, 0, 255, 255, 255, 0, 255, 255, 255) ;
                        getPrinter().GxDrawText(context.GetMessage( "Qtd de Horas", ""), 208, Gx_line+33, 316, Gx_line+51, 0, 0, 0, 0) ;
                        Gx_OldLine = Gx_line;
                        ...
                        if ( AV85GestaoServicoTipoHH == 2 )
                        {
                           ...
                           {
                              A341FuncaoTipoHHId = P008B9_A341FuncaoTipoHHId[0];
                              A163FuncaoId = P008B9_A163FuncaoId[0];
                              A343FuncaoTipoHHDescricao = P008B9_A343FuncaoTipoHHDescricao[0];
                              A338FuncaoTipoHoraValor = P008B9_A338FuncaoTipoHoraValor[0];
                              A343FuncaoTipoHHDescricao = P008B9_A343FuncaoTipoHHDescricao[0];
                              AV83FuncaoTipoHoraDescricao = A343FuncaoTipoHHDescricao;
                              AV84FuncaoTipoHoraValorDescricao = context.GetMessage( "R$", "") + StringUtil.Trim( StringUtil.Str( A338FuncaoTipoHoraValor, 18, 2));
                              H8B0( false, 17) ;
                              getPrinter().GxDrawRect(192, Gx_line+0, 284, Gx_line+17, 1, 0, 0, 0, 0, 255, 255, 255, 0, 1, 1, 0, 0, 0, 0, 0) ;
                              getPrinter().GxDrawRect(67, Gx_line+0, 684, Gx_line+17, 1, 0, 0, 0, 0, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0, 0) ;
                              getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                              getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV83FuncaoTipoHoraDescricao, "")), 83, Gx_line+0, 191, Gx_line+15, 0, 0, 0, 0) ;
                              getPrinter().GxDrawRect(333, Gx_line+0, 425, Gx_line+17, 1, 0, 0, 0, 0, 255, 255, 255, 0, 1, 1, 0, 0, 0, 0, 0) ;
                              getPrinter().GxAttris("Microsoft Sans Serif", 9, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                              getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(AV86QtdHoras), "ZZZ9")), 208, Gx_line+0, 325, Gx_line+17, 0, 0, 0, 0) ;
                              getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV84FuncaoTipoHoraValorDescricao, "")), 350, Gx_line+0, 575, Gx_line+17, 0, 0, 0, 0) ;
                              Gx_OldLine = Gx_line;
                              Gx_line = (int)(Gx_line+17);
                        ...
                        {
                           /* Using cursor P008B10 */
                           pr_default.execute(8, new Object[] {AV89GestaoServicoIdVarChar, AV91ServicoExecutanteIdVarChar});
                           while ( (pr_default.getStatus(8) != 101) )
                           {
                              A55ServicoExecutanteId = P008B10_A55ServicoExecutanteId[0];
                              n55ServicoExecutanteId = P008B10_n55ServicoExecutanteId[0];
                              A38GestaoServicoId = P008B10_A38GestaoServicoId[0];
                              A423ExecutanteTipoHoraDescricao = P008B10_A423ExecutanteTipoHoraDescricao[0];
                              A424GestaoServicoExecutanteQtdHora = P008B10_A424GestaoServicoExecutanteQtdHora[0];
                              A422ExecutanteTipoHoraId = P008B10_A422ExecutanteTipoHoraId[0];
                              n422ExecutanteTipoHoraId = P008B10_n422ExecutanteTipoHoraId[0];
                              A131GestaoServicoExecutanteId = P008B10_A131GestaoServicoExecutanteId[0];
                              A423ExecutanteTipoHoraDescricao = P008B10_A423ExecutanteTipoHoraDescricao[0];
                              AV83FuncaoTipoHoraDescricao = A423ExecutanteTipoHoraDescricao;
                              AV86QtdHoras = A424GestaoServicoExecutanteQtdHora;
                              AV92ExecutanteTipoHoraId = A422ExecutanteTipoHoraId;
                              /* Using cursor P008B11 */
                              pr_default.execute(9, new Object[] {AV62UsuarioFuncaoId, AV92ExecutanteTipoHoraId});
                              while ( (pr_default.getStatus(9) != 101) )
                              {
                                 A341FuncaoTipoHHId = P008B11_A341FuncaoTipoHHId[0];
                                 A163FuncaoId = P008B11_A163FuncaoId[0];
                                 A338FuncaoTipoHoraValor = P008B11_A338FuncaoTipoHoraValor[0];
                                 AV84FuncaoTipoHoraValorDescricao = context.GetMessage( "R$", "") + StringUtil.Trim( StringUtil.Str( A338FuncaoTipoHoraValor, 18, 2));
                                 /* Exiting from a For First loop. */
                                 if (true) break;
                              }
            ...
            if ( AV87Tela == 1 )
            {
               ...
               AV108GXLvl125 = 0;
               /* Using cursor P008B12 */
               pr_default.execute(10, new Object[] {AV29GestaoServicoId});
               while ( (pr_default.getStatus(10) != 101) )
               {
                  A133OrdemExecutanteUsuarioId = P008B12_A133OrdemExecutanteUsuarioId[0];
                  A145OrdemGestaoServicoId = P008B12_A145OrdemGestaoServicoId[0];
                  A134OrdemExecutanteUsuarioNome = P008B12_A134OrdemExecutanteUsuarioNome[0];
                  A137OrdemExecutanteHrInicio = P008B12_A137OrdemExecutanteHrInicio[0];
                  A136OrdemExecutanteDtInicio = P008B12_A136OrdemExecutanteDtInicio[0];
                  A139OrdemExecutanteHrConclusao = P008B12_A139OrdemExecutanteHrConclusao[0];
                  A140OrdemExecutanteComentario = P008B12_A140OrdemExecutanteComentario[0];
                  A142OrdemExecutanteValor = P008B12_A142OrdemExecutanteValor[0];
                  A135OrdemExecutanteId = P008B12_A135OrdemExecutanteId[0];
                  A134OrdemExecutanteUsuarioNome = P008B12_A134OrdemExecutanteUsuarioNome[0];
                  AV108GXLvl125 = 1;
                  ...
                  getPrinter().GxDrawRect(325, Gx_line+0, 375, Gx_line+17, 1, 0, 0, 0, 0, 255, 255, 255, 1, 1, 0, 1, 0, 0, 0, 0) ;
                  getPrinter().GxDrawRect(525, Gx_line+0, 575, Gx_line+17, 1, 0, 0, 0, 0, 255, 255, 255, 1, 1, 0, 1, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV45ServicoExecutanteNome, "")), 83, Gx_line+0, 175, Gx_line+15, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+17);
               ...
               if ( AV108GXLvl125 == 0 )
               {
                  /* Using cursor P008B13 */
                  pr_default.execute(11, new Object[] {AV89GestaoServicoIdVarChar});
                  while ( (pr_default.getStatus(11) != 101) )
                  {
                     A55ServicoExecutanteId = P008B13_A55ServicoExecutanteId[0];
                     n55ServicoExecutanteId = P008B13_n55ServicoExecutanteId[0];
                     A38GestaoServicoId = P008B13_A38GestaoServicoId[0];
                     A56ServicoExecutanteNome = P008B13_A56ServicoExecutanteNome[0];
                     A131GestaoServicoExecutanteId = P008B13_A131GestaoServicoExecutanteId[0];
                     A56ServicoExecutanteNome = P008B13_A56ServicoExecutanteNome[0];
      ...
      public override void initialize( )
      {
         ...
         P008B2_A36ServicoSetorId = new long[1] ;
         P008B2_A38GestaoServicoId = new long[1] ;
         P008B2_A77ServicoEmpresaId = new long[1] ;
         P008B2_A79GestaoServicoNumero = new long[1] ;
         P008B2_A40GestaoServicoDescricao = new string[] {""} ;
         P008B2_A35ServicoClienteNome = new string[] {""} ;
         P008B2_A37ServicoSetorNome = new string[] {""} ;
         P008B2_A54ServicoNaturezaNome = new string[] {""} ;
         P008B2_A41GestaoServicoPrioridade = new short[1] ;
         P008B2_A42GestaoServicoStatus = new short[1] ;
         P008B2_A43GestaoServicoDtProgramada = new DateTime[] {DateTime.MinValue} ;
         P008B2_A39GestaoServicoDtHora = new DateTime[] {DateTime.MinValue} ;
         P008B2_A157GestaoServicoPrecificacao = new short[1] ;
         P008B2_A53ServicoNaturezaId = new long[1] ;
         P008B2_n53ServicoNaturezaId = new bool[] {false} ;
         P008B2_A129EnderecoId = new long[1] ;
         P008B2_n129EnderecoId = new bool[] {false} ;
         P008B2_A34ServicoClienteId = new long[1] ;
         P008B2_A322GestaoServicoTipoDemanda = new short[1] ;
         P008B2_A420GestaoServicoTipoHH = new short[1] ;
         P008B2_n420GestaoServicoTipoHH = new bool[] {false} ;
         ...
         P008B3_A106ClienteEnderecoId = new long[1] ;
         P008B3_A17ClienteId = new long[1] ;
         P008B3_A107ClienteEnderecoLocal = new string[] {""} ;
         A107ClienteEnderecoLocal = "";
         AV20EnderecoLocal = "";
         P008B4_A1EmpresaId = new long[1] ;
         P008B4_A2EmpresaNome = new string[] {""} ;
         P008B4_A3EmpresaCNPJ = new string[] {""} ;
         P008B4_A40000EmpresaFoto_GXI = new string[] {""} ;
         A2EmpresaNome = "";
         A3EmpresaCNPJ = "";
         ...
         sImgUrl = "";
         AV76EmpresaContato = "";
         P008B5_A38GestaoServicoId = new long[1] ;
         P008B5_A326TipoServicoNome = new string[] {""} ;
         P008B5_A329TipoServicoEstimado = new short[1] ;
         P008B5_A325TipoServicoId = new long[1] ;
         P008B5_A323GestaoServicoTipoId = new long[1] ;
         A326TipoServicoNome = "";
         AV69TempoEstimado = "";
         ...
         P008B6_A25NaturezaId = new long[1] ;
         P008B6_A162NaturezaValor = new decimal[1] ;
         P008B6_A289NaturezaCusto = new decimal[1] ;
         ...
         P008B7_A38GestaoServicoId = new long[1] ;
         P008B7_A55ServicoExecutanteId = new long[1] ;
         P008B7_n55ServicoExecutanteId = new bool[] {false} ;
         P008B7_A131GestaoServicoExecutanteId = new long[1] ;
         AV44ServicoExecutanteIdCollection = new GxSimpleCollection<long>();
         AV91ServicoExecutanteIdVarChar = "";
         P008B8_A9UsuarioId = new long[1] ;
         P008B8_A173UsuarioFuncaoId = new long[1] ;
         P008B8_n173UsuarioFuncaoId = new bool[] {false} ;
         P008B8_A10UsuarioNome = new string[] {""} ;
         A10UsuarioNome = "";
         AV75TecnicoNome = "";
         P008B9_A341FuncaoTipoHHId = new long[1] ;
         P008B9_A163FuncaoId = new long[1] ;
         P008B9_A343FuncaoTipoHHDescricao = new string[] {""} ;
         P008B9_A338FuncaoTipoHoraValor = new decimal[1] ;
         A343FuncaoTipoHHDescricao = "";
         AV83FuncaoTipoHoraDescricao = "";
         AV84FuncaoTipoHoraValorDescricao = "";
         P008B10_A55ServicoExecutanteId = new long[1] ;
         P008B10_n55ServicoExecutanteId = new bool[] {false} ;
         P008B10_A38GestaoServicoId = new long[1] ;
         P008B10_A423ExecutanteTipoHoraDescricao = new string[] {""} ;
         P008B10_A424GestaoServicoExecutanteQtdHora = new short[1] ;
         P008B10_A422ExecutanteTipoHoraId = new long[1] ;
         P008B10_n422ExecutanteTipoHoraId = new bool[] {false} ;
         P008B10_A131GestaoServicoExecutanteId = new long[1] ;
         A423ExecutanteTipoHoraDescricao = "";
         P008B11_A341FuncaoTipoHHId = new long[1] ;
         P008B11_A163FuncaoId = new long[1] ;
         P008B11_A338FuncaoTipoHoraValor = new decimal[1] ;
         P008B12_A133OrdemExecutanteUsuarioId = new long[1] ;
         P008B12_A145OrdemGestaoServicoId = new long[1] ;
         P008B12_A134OrdemExecutanteUsuarioNome = new string[] {""} ;
         P008B12_A137OrdemExecutanteHrInicio = new DateTime[] {DateTime.MinValue} ;
         P008B12_A136OrdemExecutanteDtInicio = new DateTime[] {DateTime.MinValue} ;
         P008B12_A139OrdemExecutanteHrConclusao = new DateTime[] {DateTime.MinValue} ;
         P008B12_A140OrdemExecutanteComentario = new string[] {""} ;
         P008B12_A142OrdemExecutanteValor = new decimal[1] ;
         P008B12_A135OrdemExecutanteId = new long[1] ;
         ...
         P008B13_A55ServicoExecutanteId = new long[1] ;
         P008B13_n55ServicoExecutanteId = new bool[] {false} ;
         P008B13_A38GestaoServicoId = new long[1] ;
         P008B13_A56ServicoExecutanteNome = new string[] {""} ;
         P008B13_A131GestaoServicoExecutanteId = new long[1] ;
         A56ServicoExecutanteNome = "";
         AV88MsgVarChar = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aprcimpressaoosmodelo5__default(),
            new Object[][] {
                new Object[] {
               P008B2_A36ServicoSetorId, P008B2_A38GestaoServicoId, P008B2_A77ServicoEmpresaId, P008B2_A79GestaoServicoNumero, P008B2_A40GestaoServicoDescricao, P008B2_A35ServicoClienteNome, P008B2_A37ServicoSetorNome, P008B2_A54ServicoNaturezaNome, P008B2_A41GestaoServicoPrioridade, P008B2_A42GestaoServicoStatus,
               P008B2_A43GestaoServicoDtProgramada, P008B2_A39GestaoServicoDtHora, P008B2_A157GestaoServicoPrecificacao, P008B2_A53ServicoNaturezaId, P008B2_n53ServicoNaturezaId, P008B2_A129EnderecoId, P008B2_n129EnderecoId, P008B2_A34ServicoClienteId, P008B2_A322GestaoServicoTipoDemanda, P008B2_A420GestaoServicoTipoHH,
               P008B2_n420GestaoServicoTipoHH
               }
               , new Object[] {
               P008B3_A106ClienteEnderecoId, P008B3_A17ClienteId, P008B3_A107ClienteEnderecoLocal
               }
               , new Object[] {
               P008B4_A1EmpresaId, P008B4_A2EmpresaNome, P008B4_A3EmpresaCNPJ, P008B4_A40000EmpresaFoto_GXI
               }
               , new Object[] {
               P008B5_A38GestaoServicoId, P008B5_A326TipoServicoNome, P008B5_A329TipoServicoEstimado, P008B5_A325TipoServicoId, P008B5_A323GestaoServicoTipoId
               }
               , new Object[] {
               P008B6_A25NaturezaId, P008B6_A162NaturezaValor, P008B6_A289NaturezaCusto
               }
               , new Object[] {
               P008B7_A38GestaoServicoId, P008B7_A55ServicoExecutanteId, P008B7_n55ServicoExecutanteId, P008B7_A131GestaoServicoExecutanteId
               }
               , new Object[] {
               P008B8_A9UsuarioId, P008B8_A173UsuarioFuncaoId, P008B8_n173UsuarioFuncaoId, P008B8_A10UsuarioNome
               }
               , new Object[] {
               P008B9_A341FuncaoTipoHHId, P008B9_A163FuncaoId, P008B9_A343FuncaoTipoHHDescricao, P008B9_A338FuncaoTipoHoraValor
               }
               , new Object[] {
               P008B10_A55ServicoExecutanteId, P008B10_n55ServicoExecutanteId, P008B10_A38GestaoServicoId, P008B10_A423ExecutanteTipoHoraDescricao, P008B10_A424GestaoServicoExecutanteQtdHora, P008B10_A422ExecutanteTipoHoraId, P008B10_n422ExecutanteTipoHoraId, P008B10_A131GestaoServicoExecutanteId
               }
               , new Object[] {
               P008B11_A341FuncaoTipoHHId, P008B11_A163FuncaoId, P008B11_A338FuncaoTipoHoraValor
               }
               , new Object[] {
               P008B12_A133OrdemExecutanteUsuarioId, P008B12_A145OrdemGestaoServicoId, P008B12_A134OrdemExecutanteUsuarioNome, P008B12_A137OrdemExecutanteHrInicio, P008B12_A136OrdemExecutanteDtInicio, P008B12_A139OrdemExecutanteHrConclusao, P008B12_A140OrdemExecutanteComentario, P008B12_A142OrdemExecutanteValor, P008B12_A135OrdemExecutanteId
               }
               , new Object[] {
               P008B13_A55ServicoExecutanteId, P008B13_n55ServicoExecutanteId, P008B13_A38GestaoServicoId, P008B13_A56ServicoExecutanteNome, P008B13_A131GestaoServicoExecutanteId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string AV83FuncaoTipoHoraDescricao ;
      ...
      private string AV84FuncaoTipoHoraValorDescricao ;
      ...
      private long[] P008B2_A36ServicoSetorId ;
      private long[] P008B2_A38GestaoServicoId ;
      private long[] P008B2_A77ServicoEmpresaId ;
      private long[] P008B2_A79GestaoServicoNumero ;
      private string[] P008B2_A40GestaoServicoDescricao ;
      private string[] P008B2_A35ServicoClienteNome ;
      private string[] P008B2_A37ServicoSetorNome ;
      private string[] P008B2_A54ServicoNaturezaNome ;
      private short[] P008B2_A41GestaoServicoPrioridade ;
      private short[] P008B2_A42GestaoServicoStatus ;
      private DateTime[] P008B2_A43GestaoServicoDtProgramada ;
      private DateTime[] P008B2_A39GestaoServicoDtHora ;
      private short[] P008B2_A157GestaoServicoPrecificacao ;
      private long[] P008B2_A53ServicoNaturezaId ;
      private bool[] P008B2_n53ServicoNaturezaId ;
      private long[] P008B2_A129EnderecoId ;
      private bool[] P008B2_n129EnderecoId ;
      private long[] P008B2_A34ServicoClienteId ;
      private short[] P008B2_A322GestaoServicoTipoDemanda ;
      private short[] P008B2_A420GestaoServicoTipoHH ;
      private bool[] P008B2_n420GestaoServicoTipoHH ;
      private long[] P008B3_A106ClienteEnderecoId ;
      private long[] P008B3_A17ClienteId ;
      private string[] P008B3_A107ClienteEnderecoLocal ;
      private long[] P008B4_A1EmpresaId ;
      private string[] P008B4_A2EmpresaNome ;
      private string[] P008B4_A3EmpresaCNPJ ;
      private string[] P008B4_A40000EmpresaFoto_GXI ;
      private long[] P008B5_A38GestaoServicoId ;
      private string[] P008B5_A326TipoServicoNome ;
      private short[] P008B5_A329TipoServicoEstimado ;
      private long[] P008B5_A325TipoServicoId ;
      private long[] P008B5_A323GestaoServicoTipoId ;
      private GxSimpleCollection<long> AV82ServicoNaturezaIdCollection ;
      private long[] P008B6_A25NaturezaId ;
      private decimal[] P008B6_A162NaturezaValor ;
      private decimal[] P008B6_A289NaturezaCusto ;
      private long[] P008B7_A38GestaoServicoId ;
      private long[] P008B7_A55ServicoExecutanteId ;
      private bool[] P008B7_n55ServicoExecutanteId ;
      private long[] P008B7_A131GestaoServicoExecutanteId ;
      private GxSimpleCollection<long> AV44ServicoExecutanteIdCollection ;
      private long[] P008B8_A9UsuarioId ;
      private long[] P008B8_A173UsuarioFuncaoId ;
      private bool[] P008B8_n173UsuarioFuncaoId ;
      private string[] P008B8_A10UsuarioNome ;
      private long[] P008B9_A341FuncaoTipoHHId ;
      private long[] P008B9_A163FuncaoId ;
      private string[] P008B9_A343FuncaoTipoHHDescricao ;
      private decimal[] P008B9_A338FuncaoTipoHoraValor ;
      private long[] P008B10_A55ServicoExecutanteId ;
      private bool[] P008B10_n55ServicoExecutanteId ;
      private long[] P008B10_A38GestaoServicoId ;
      private string[] P008B10_A423ExecutanteTipoHoraDescricao ;
      private short[] P008B10_A424GestaoServicoExecutanteQtdHora ;
      private long[] P008B10_A422ExecutanteTipoHoraId ;
      private bool[] P008B10_n422ExecutanteTipoHoraId ;
      private long[] P008B10_A131GestaoServicoExecutanteId ;
      private long[] P008B11_A341FuncaoTipoHHId ;
      private long[] P008B11_A163FuncaoId ;
      private decimal[] P008B11_A338FuncaoTipoHoraValor ;
      private long[] P008B12_A133OrdemExecutanteUsuarioId ;
      private long[] P008B12_A145OrdemGestaoServicoId ;
      private string[] P008B12_A134OrdemExecutanteUsuarioNome ;
      private DateTime[] P008B12_A137OrdemExecutanteHrInicio ;
      private DateTime[] P008B12_A136OrdemExecutanteDtInicio ;
      private DateTime[] P008B12_A139OrdemExecutanteHrConclusao ;
      private string[] P008B12_A140OrdemExecutanteComentario ;
      private decimal[] P008B12_A142OrdemExecutanteValor ;
      private long[] P008B12_A135OrdemExecutanteId ;
      private long[] P008B13_A55ServicoExecutanteId ;
      private bool[] P008B13_n55ServicoExecutanteId ;
      private long[] P008B13_A38GestaoServicoId ;
      private string[] P008B13_A56ServicoExecutanteNome ;
      private long[] P008B13_A131GestaoServicoExecutanteId ;
   }

   public class aprcimpressaoosmodelo5__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmP008B10;
          prmP008B10 = new Object[] {
          new ParDef("@AV89GestaoServicoIdVarChar",GXType.VarChar,40,0) ,
          new ParDef("@AV91ServicoExecutanteIdVarChar",GXType.VarChar,40,0)
          };
          Object[] prmP008B11;
          prmP008B11 = new Object[] {
          new ParDef("@AV62UsuarioFuncaoId",GXType.Decimal,18,0) ,
          new ParDef("@AV92ExecutanteTipoHoraId",GXType.Decimal,18,0)
          };
          Object[] prmP008B12;
          prmP008B12 = new Object[] {
          new ParDef("@AV29GestaoServicoId",GXType.Decimal,18,0)
          };
          Object[] prmP008B13;
          prmP008B13 = new Object[] {
          new ParDef("@AV89GestaoServicoIdVarChar",GXType.VarChar,40,0)
          };
          def= new CursorDef[] {
              new CursorDef("P008B2", "SELECT T1.[ServicoSetorId] AS ServicoSetorId, T1.[GestaoServicoId], T1.[ServicoEmpresaId], T1.[GestaoServicoNumero], T1.[GestaoServicoDescricao], T4.[ClienteNome] AS ServicoClienteNome, T2.[SetorNome] AS ServicoSetorNome, T3.[NaturezaNome] AS ServicoNaturezaNome, T1.[GestaoServicoPrioridade], T1.[GestaoServicoStatus], T1.[GestaoServicoDtProgramada], T1.[GestaoServicoDtHora], T1.[GestaoServicoPrecificacao], T1.[ServicoNaturezaId] AS ServicoNaturezaId, T1.[EnderecoId], T1.[ServicoClienteId] AS ServicoClienteId, T1.[GestaoServicoTipoDemanda], T1.[GestaoServicoTipoHH] FROM ((([GestaoServico] T1 INNER JOIN [Setor] T2 ON T2.[SetorId] = T1.[ServicoSetorId]) LEFT JOIN [Natureza] T3 ON T3.[NaturezaId] = T1.[ServicoNaturezaId]) INNER JOIN [Cliente] T4 ON T4.[ClienteId] = T1.[ServicoClienteId]) WHERE T1.[GestaoServicoId] = @AV29GestaoServicoId ORDER BY T1.[GestaoServicoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P008B3", "SELECT [ClienteEnderecoId], [ClienteId], [ClienteEnderecoLocal] FROM [ClienteEndereco] WHERE [ClienteId] = @AV41ServicoClienteId and [ClienteEnderecoId] = @AV19EnderecoId ORDER BY [ClienteId], [ClienteEnderecoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P008B4", "SELECT [EmpresaId], [EmpresaNome], [EmpresaCNPJ], [EmpresaFoto_GXI] FROM [Empresa] WHERE [EmpresaId] = @AV43ServicoEmpresaId ORDER BY [EmpresaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B4,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P008B5", "SELECT T1.[GestaoServicoId], T2.[NaturezaNome] AS TipoServicoNome, T2.[NaturezaTempoEstimado] AS TipoServicoEstimado, T1.[TipoServicoId] AS TipoServicoId, T1.[GestaoServicoTipoId] FROM ([GestaoServicoTipo] T1 INNER JOIN [Natureza] T2 ON T2.[NaturezaId] = T1.[TipoServicoId]) WHERE T1.[GestaoServicoId] = @AV29GestaoServicoId ORDER BY T1.[GestaoServicoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B5,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P008B6", "SELECT [NaturezaId], [NaturezaValor], [NaturezaCusto] FROM [Natureza] WHERE [NaturezaId] = @AV46ServicoNaturezaId ORDER BY [NaturezaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B6,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P008B7", "SELECT [GestaoServicoId], [ServicoExecutanteId] AS ServicoExecutanteId, [GestaoServicoExecutanteId] FROM [GestaoServicoExecutante] WHERE [GestaoServicoId] = CONVERT( DECIMAL(28,14), @AV89GestaoServicoIdVarChar) ORDER BY [GestaoServicoExecutanteId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B7,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P008B8", "SELECT [UsuarioId], [UsuarioFuncaoId], [UsuarioNome] FROM [Usuario] WHERE [UsuarioId] = @AV79ServicoExecutanteId ORDER BY [UsuarioId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B8,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P008B9", "SELECT T1.[FuncaoTipoHHId] AS FuncaoTipoHHId, T1.[FuncaoId], T2.[TipoHoraDescricao] AS FuncaoTipoHHDescricao, T1.[FuncaoTipoHoraValor] FROM ([FuncaoTipoHora] T1 INNER JOIN [TipoHora] T2 ON T2.[TipoHoraId] = T1.[FuncaoTipoHHId]) WHERE T1.[FuncaoId] = @AV62UsuarioFuncaoId ORDER BY T1.[FuncaoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B9,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P008B10", "SELECT T1.[ServicoExecutanteId] AS ServicoExecutanteId, T1.[GestaoServicoId], T2.[TipoHoraDescricao] AS ExecutanteTipoHoraDescricao, T1.[GestaoServicoExecutanteQtdHora], T1.[ExecutanteTipoHoraId] AS ExecutanteTipoHoraId, T1.[GestaoServicoExecutanteId] FROM ([GestaoServicoExecutante] T1 LEFT JOIN [TipoHora] T2 ON T2.[TipoHoraId] = T1.[ExecutanteTipoHoraId]) WHERE (T1.[GestaoServicoId] = CONVERT( DECIMAL(28,14), @AV89GestaoServicoIdVarChar)) AND (T1.[ServicoExecutanteId] = CONVERT( DECIMAL(28,14), @AV91ServicoExecutanteIdVarChar)) ORDER BY T1.[GestaoServicoExecutanteId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B10,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P008B11", "SELECT [FuncaoTipoHHId] AS FuncaoTipoHHId, [FuncaoId], [FuncaoTipoHoraValor] FROM [FuncaoTipoHora] WHERE [FuncaoId] = @AV62UsuarioFuncaoId and [FuncaoTipoHHId] = @AV92ExecutanteTipoHoraId ORDER BY [FuncaoId], [FuncaoTipoHHId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B11,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P008B12", "SELECT T1.[OrdemExecutanteUsuarioId] AS OrdemExecutanteUsuarioId, T1.[OrdemGestaoServicoId], T2.[UsuarioNome] AS OrdemExecutanteUsuarioNome, T1.[OrdemExecutanteHrInicio], T1.[OrdemExecutanteDtInicio], T1.[OrdemExecutanteHrConclusao], T1.[OrdemExecutanteComentario], T1.[OrdemExecutanteValor], T1.[OrdemExecutanteId] FROM ([OrdemExecutante] T1 INNER JOIN [Usuario] T2 ON T2.[UsuarioId] = T1.[OrdemExecutanteUsuarioId]) WHERE T1.[OrdemGestaoServicoId] = @AV29GestaoServicoId ORDER BY T1.[OrdemGestaoServicoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B12,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P008B13", "SELECT T1.[ServicoExecutanteId] AS ServicoExecutanteId, T1.[GestaoServicoId], T2.[UsuarioNome] AS ServicoExecutanteNome, T1.[GestaoServicoExecutanteId] FROM ([GestaoServicoExecutante] T1 LEFT JOIN [Usuario] T2 ON T2.[UsuarioId] = T1.[ServicoExecutanteId]) WHERE T1.[GestaoServicoId] = CONVERT( DECIMAL(28,14), @AV89GestaoServicoIdVarChar) ORDER BY T1.[GestaoServicoExecutanteId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008B13,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
