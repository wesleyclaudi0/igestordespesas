...
namespace GeneXus.Programs {
   public class aimpressaomedicao : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public aimpressaomedicao( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         try
         {
            ...
            AV66DateTime = DateTimeUtil.Now( context);
            /* Using cursor P00GN2 */
            ...
            while ( (pr_default.getStatus(3) != 101) )
            {
               ...
               while ( (pr_default.getStatus(4) != 101) )
               {
                  ...
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(AV98MedicaoProfissionalSaldo), "ZZZZZZZZZZZ9")), 820, Gx_line+13, 928, Gx_line+28, 0, 0, 0, 0) ;
               ...
               if ( AV107GXLvl55 == 0 )
               {
                  ...
                  AV75MedicaoDiferenca = 0;
                  AV78MedicaoHoras = 0;
                  AV49MedicaoQtd = 0;
                  AV48HoraMes = 0;
                  AV94Valor = 0;
                  AV92Total = 0;
                  AV98MedicaoProfissionalSaldo = 0;
                  HGN0( false, 40) ;
                  getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(AV48HoraMes), "ZZZ9")), 173, Gx_line+13, 256, Gx_line+28, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( AV94Valor, "ZZZZZZZZZZZZZZ9.99")), 360, Gx_line+13, 418, Gx_line+28, 0, 0, 0, 0) ;
               ...
               if ( AV108GXLvl78 == 0 )
               {
                  ...
                  AV87ProdutoPreco = 0;
                  AV88ProdutoUnidade = "";
                  AV96MedicaoProdutoQtdInicial = 0;
                  AV97MedicaoProdutoSaldo = 0;
                  HGN0( false, 40) ;
                  getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( AV97MedicaoProdutoSaldo, "ZZZZZZZZ9.99")), 593, Gx_line+13, 685, Gx_line+28, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( AV96MedicaoProdutoQtdInicial, "ZZZZZZZZ9.99")), 367, Gx_line+13, 450, Gx_line+28, 0, 0, 0, 0) ;
               ...
               if ( AV109GXLvl97 == 0 )
               {
                  ...
                  AV83MedicaoTipoServicoQtd = 0;
                  AV99MedicaoTipoServicoValor = 0;
                  HGN0( false, 40) ;
                  getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV84MedicaoUnidadeNome, "")), 173, Gx_line+13, 290, Gx_line+28, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV82MedicaoTipoServicoNome, "")), 47, Gx_line+13, 154, Gx_line+28, 0, 0, 0, 0) ;
                           ...
                           int Inc )
      {
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( Gx_line + Inc >= P_lines )
            {
               ...
               getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV22ClienteEmail, "")), 587, Gx_line+147, 854, Gx_line+162, 0, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aimpressaomedicao__default(),
            new Object[][] {
                new Object[] {
      ...
      private short AV108GXLvl78 ;
      private short AV89Qtd ;
      private short AV109GXLvl97 ;
      private int M_top ;
      private int M_bot ;
      private int Line ;
      private int ToSkip ;
   ...
   public class aimpressaomedicao__default : DataStoreHelperBase, IDataStoreHelper
   {
