...
namespace GeneXus.Programs {
   public class aprcrelatoriomodelo5 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public aprcrelatoriomodelo5( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         try
         {
            ...
            {
               A1EmpresaId = P007Z2_A1EmpresaId[0];
               A2EmpresaNome = P007Z2_A2EmpresaNome[0];
               A40000EmpresaFoto_GXI = P007Z2_A40000EmpresaFoto_GXI[0];
               A3EmpresaCNPJ = P007Z2_A3EmpresaCNPJ[0];
               A4EmpresaContato = P007Z2_A4EmpresaContato[0];
               A5EmpresaEndereco = P007Z2_A5EmpresaEndereco[0];
               AV14Descricao = StringUtil.Trim( A2EmpresaNome);
            ...
            AV78Total2VarChar = context.GetMessage( "R$ 450", "");
            AV66n = 1;
            while ( AV66n <= 3 )
            {
            ...
            getPrinter().GxAttris("Microsoft Sans Serif", 9, true, false, false, false, 0, 255, 255, 255, 0, 255, 255, 255) ;
            getPrinter().GxDrawText(context.GetMessage( "Técnico", ""), 83, Gx_line+0, 166, Gx_line+18, 0, 0, 0, 0) ;
            ...
            getPrinter().GxDrawText(context.GetMessage( "Noturno", ""), 625, Gx_line+0, 683, Gx_line+18, 0, 0, 0, 0) ;
            ...
            getPrinter().GxDrawRect(542, Gx_line+0, 544, Gx_line+17, 1, 0, 0, 0, 0, 255, 255, 255, 0, 1, 0, 1, 0, 0, 0, 0) ;
      ...
      public override void initialize( )
      {
         ...
         P007Z2_A1EmpresaId = new long[1] ;
         P007Z2_A2EmpresaNome = new string[] {""} ;
         P007Z2_A40000EmpresaFoto_GXI = new string[] {""} ;
         P007Z2_A3EmpresaCNPJ = new string[] {""} ;
         P007Z2_A4EmpresaContato = new string[] {""} ;
         P007Z2_A5EmpresaEndereco = new string[] {""} ;
         A2EmpresaNome = "";
         ...
         AV59FuncaoNoturno = "";
         AV60FuncaoDiaria = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aprcrelatoriomodelo5__default(),
            new Object[][] {
                new Object[] {
               P007Z2_A1EmpresaId, P007Z2_A2EmpresaNome, P007Z2_A40000EmpresaFoto_GXI, P007Z2_A3EmpresaCNPJ, P007Z2_A4EmpresaContato, P007Z2_A5EmpresaEndereco
               }
            }
         );
      ...
      private long[] P007Z2_A1EmpresaId ;
      private string[] P007Z2_A2EmpresaNome ;
      private string[] P007Z2_A40000EmpresaFoto_GXI ;
      private string[] P007Z2_A3EmpresaCNPJ ;
      private string[] P007Z2_A4EmpresaContato ;
      private string[] P007Z2_A5EmpresaEndereco ;
   }

   public class aprcrelatoriomodelo5__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P007Z2", "SELECT [EmpresaId], [EmpresaNome], [EmpresaFoto_GXI], [EmpresaCNPJ], [EmpresaContato], [EmpresaEndereco] FROM [Empresa] WHERE [EmpresaId] = @AV73EmpresaId ORDER BY [EmpresaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007Z2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
